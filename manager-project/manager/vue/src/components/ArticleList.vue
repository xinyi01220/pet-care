...
export default {
  ...
  methods: {
    ...
    loadBlogs(pageNum) {
      ...
      let url
      switch (this.type) {
        case 'user': url = '/article/selectUser'; break;
        case 'like': url = '/article/selectLike'; break;
        case 'collect': url = '/article/selectCollect'; break;
        case 'comment': url = '/article/selectComment'; break;
        default: url = '/article/selectPage'
      }
