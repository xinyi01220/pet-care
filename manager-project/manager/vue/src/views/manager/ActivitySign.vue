...
<!--        <el-table-column prop="departmentName" label="所属组织" show-overflow-tooltip>-->
<!--          <template slot-scope="scope">-->
<!--            <span v-if="scope.row.departmentName !== null">{{ scope.row.departmentName }}</span>-->
<!--            <span v-else>暂未加入任何组织</span>-->
<!--          </template>-->
<!--        </el-table-column>-->
